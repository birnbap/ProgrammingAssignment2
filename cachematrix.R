...
#makeMatrix - Contractor function to a structure to be used with the cacheSolve function  
...
#cacheSolve : Returns an inverse matrix from memory if pre calculated
